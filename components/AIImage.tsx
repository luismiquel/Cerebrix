...
const AIImage: React.FC<Props> = ({ prompt, className }) => {
  // Generar un "arte" determinista basado en el prompt sin usar API externa
  const artStyle = useMemo(() => {
    ...
    const type = Math.abs(hash % 3); // 0: gradient, 1: radial, 2: conic
  ...
  return (
    <div 
      ...
      style={artStyle}
    >
        {/* Capa de textura para que parezca más "arte" */}
        ...
        {/* Icono central decorativo generado por texto */}
